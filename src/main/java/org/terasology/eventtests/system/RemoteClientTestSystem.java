...
public class RemoteClientTestSystem extends BaseComponentSystem {

    private static final Logger logger = LoggerFactory.getLogger(RemoteClientTestSystem.class);
